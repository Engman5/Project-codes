import 'package:consumerplus/screens/dashboard/settings_screen.dart';
...
class DashboardScreen extends StatelessWidget {
  ...
  // Logout method now uses AuthService
  Future<void> _logout(BuildContext context) async {
    try {
      await AuthService().signOut(context); // Use signOut method from AuthService
    } catch (e) {
